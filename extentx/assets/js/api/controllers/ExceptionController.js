angular.module('ExtentX')
    ...
    function($rootScope, $scope, $http, $location, $sce, Icon, ChartSettings, BarChartSettings, LineChartSettings, PieChartSettings,DataPointFormat) {
        ...
        $scope.getExceptionDistributionByReportByProject = function(days) {
            ...
            $http(req).
                success(function(res) {                    
                    ...
                    for (var ix = 0; ix < res.length; ix++) {
                        $scope.exceptionReportDistLabels.push(res[ix].name+res[ix].time);
